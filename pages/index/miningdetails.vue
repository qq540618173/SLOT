<template>
	<view class="miningdetails">
		...
		<view class="container">
			...
			<view class="price" v-if="comboInfo.type == 1">
				<text>{{i18n.index.mining16}}</text>
				<text class="number">{{minePrice + 'USDT'}}</text>
			</view>
			<view class="price price2" v-if="comboInfo.type == 2">
				<text>{{i18n.index.mining16}}</text>
				<text class="number">{{comboInfo.min_price + '--' + comboInfo.max_price + 'USDT'}}</text>
			</view>
			<view class="rule">
		...
		<view class="modal" :class="{current: current}">
			...
			<view class="form-item" v-if="comboInfo.type == 2">
